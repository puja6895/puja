            ...
            <div class="row">
                <div class="col">
                    ...
                    <div class="container mt-3">
                        ...
                        <a href="{{url('ip-address')}}">
                            <button class="btn btn-primary mt-3">Get IP Address</button>
                        </a>
                        <a href="{{url('add')}}">
                            <button class="btn btn-primary mt-3">Send Mail</button>
                        </a>
                        <a href="{{url('get-excel-file')}}">
                            <button class="btn btn-primary mt-3">Get Excel File</button>
                        </a>
                    </div>
                    <!-- Cookies Element -->
                    ...
                    <div class="container mt-3 mb-2">
                        <h2></h2>
                        <div class="mt-4 p-5 bg-secondary text-white rounded">
                            <h6><b>Ip Address : </b>{{Cookie::get('ip_address')}}</h6> 
                            <h6><b>State : </b>{{Cookie::get('state')}}</h6> 
                            <h6><b>City : </b>{{Cookie::get('city')}}</h6> 
                        </div>
                    </div>
                    @endif
                </div>
